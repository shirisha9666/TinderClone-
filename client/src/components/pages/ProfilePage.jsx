...
//           <div className='mt-8 sx:mx-auto sm:w-full sm:max-w-md'>
...
//                className='appearance-none block w-full px-3 py-2 bprder
//                border-gray-300 rounded-md shadow-md placeholder-gray-400 focus:outline-none focus:ring-pink-500 focus:border-pink-500 sm:text-sm'/>
//                </div>
...
//               {/* gender */}
//               <div >
//                 <span className='block tem-sm font-medium text-gray-700 mb-2 '>Gender</span>
// <div className='flex  space-x-4'>
//   {["Male","Female"].map((option)=>(
//     <label key={option} className='inline-flex items-center cursor-pointer'>
//       <input type='radio' className='form-radio text-pink-600 '
//       name='gender' value={option.toLowerCase()} 
//       checked={gender===option.toLowerCase()}
//       onChange={()=>setGender(option.toLowerCase())}/> {option}</label>
//   ))}
// </div>
//               </div>
...
//               {/* genderPreference */}
//               <div >
//                 <span className='block tem-sm font-medium text-gray-700 mb-2 '>Gender Preference</span>
// <div className='flex space-x-4'>
//   {["Male","Female","both"].map((option)=>(
//     <label key={option} className='inline-flex items-center cursor-pointer'>
//       <input type='checkbox' className='form-checkbox text-pink-600 '
//       name='genderPreference' value={option.toLowerCase()} 
//       checked={genderPreference===option.toLowerCase()}
//       onChange={()=>setGenderPreference(option.toLowerCase())}/> {option}</label>
//   ))}
// </div>
//               </div>
//               {/* bio */}
...
//                <div className='mt-1'>
//                <textarea id='bio' name='bio' type='text'  rows={3}
...
//               {/* image */}
//               <div>
//               <label htmlFor='bio' className='block text-sm font-medium text-gray-700'>Cover Image</label>
...
//                    focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500'>Uplod Image</button>
...
//                 <img src={image} alt='User Image' className=' w-28 h-full object-cover rounded-md'/>
//               </div>)}
//               <button type='submit' className='w-full flex justify-center
//               py-2 px-4 border border-transparent rounded-md shadow-sm
//               text-sm font-medium text-white bg-pink-600 hover:bg-pink-700
